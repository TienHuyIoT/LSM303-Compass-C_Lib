 ...
 ***************************************************************************/
#ifndef __LSM303_U_H__
#define __LSM303_U_H__
#include <stdint.h>
#include <Sensor.h>
#include <Wire.h>
...
bool LSM303_Accel_Unified_getEvent(sensors_event_t*);
void LSM303_Accel_Unified_getSensor(sensor_t*);
extern lsm303AccelData LSM303_Accel_Unified_raw;   // Last read accelerometer data will be available here

bool LSM303_Mag_Unified_begin(int32_t sensorID);
void LSM303_Mag_Unified_enableAutoRange(bool enable);
void LSM303_Mag_Unified_setMagGain(lsm303MagGain gain);
void LSM303_Mag_Unified_setMagRate(lsm303MagRate rate);
bool LSM303_Mag_Unified_getEvent(sensors_event_t*);
void LSM303_Mag_Unified_getSensor(sensor_t*);

extern lsm303MagData   LSM303_Mag_Unified_raw;     // Last read magnetometer data will be available here
extern lsm303MagGain   magGain;
extern bool            autoRangeEnabled;

/* Non Unified (old) driver for compatibility reasons */
bool Adafruit_LSM303_begin(void);
void Adafruit_LSM303_read(void);
void Adafruit_LSM303_setMagGain(lsm303MagGain gain);

extern lsm303AccelData accelData;    // Last read accelerometer data will be available here
extern lsm303MagData magData;        // Last read magnetometer data will be available here
